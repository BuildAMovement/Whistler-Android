...
public class DialogsUtil {
    ...
    public static ProgressDialog showProgressDialog(Context context) {
        ...
        dialog.setMessage(context.getString(R.string.setting_data));
    ...
    public static AlertDialog showRemoveReportDialog(String title, Context context, final View.OnClickListener listener) {
        AlertDialog.Builder builder =
                new AlertDialog.Builder(context);
        ...
        String titleText = !TextUtils.isEmpty(title) ? "'" + title + "'" : context.getString(R.string.title_not_included);
    ...
    public static void showTrustedContactDialog(int title, final Context context, final TrustedPerson trustedPerson, final OnTrustedPersonInteractionListener listener) {
        ...
        final TextInputLayout titleLayout = (TextInputLayout) dialogView.findViewById(R.id.new_person_title_layout);
        final TextInputLayout phoneLayout = (TextInputLayout) dialogView.findViewById(R.id.new_person_phone_layout);
        final EditText name = (EditText) dialogView.findViewById(R.id.person_name);
        final EditText phoneNumber = (EditText) dialogView.findViewById(R.id.person_phone);
