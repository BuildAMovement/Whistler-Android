...
import rs.readahead.washington.mobile.data.rest.DFInterceptor;
import rs.readahead.washington.mobile.data.rest.DFOkHttpConfigurator;
...
public class OpenRosaService {
    ...
    public static class Builder {
        ...
        public Builder(OkHttpClient.Builder builder) {
            ...
            retrofitBuilder.baseUrl("https://www.whistlerapp.org/"); // dummy baseUrl to keep retrofit happy, all calls have @Url parameter

            DFOkHttpConfigurator.configure(builder);
