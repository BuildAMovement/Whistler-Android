...
public class AttachmentsActivity extends MetadataActivity implements
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (getIntent().hasExtra(REPORT_VIEW_TYPE)) {
            this.type = (ReportViewType) getIntent().getSerializableExtra(REPORT_VIEW_TYPE);
        }
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        if (type != ReportViewType.PREVIEW) {
    ...
    private void setupFab() {
        if (animated || type == ReportViewType.PREVIEW) {
    ...
    private void getAttachmentsFromIntent() {
        ...
        EvidenceData evidenceData = (EvidenceData) getIntent().getSerializableExtra(MEDIA_FILES_KEY);
        List<MediaFile> attachments = evidenceData.getEvidences();
