...
public class CollectHelpActivity extends CacheWordSubscriberBaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mReportsTextView.setText(Html.fromHtml(getString(R.string.send_report_info)));
        mReportsTextView.setMovementMethod(LinkMovementMethod.getInstance());
        StringUtils.stripUnderlines(mReportsTextView);
